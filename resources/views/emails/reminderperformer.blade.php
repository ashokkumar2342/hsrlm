...
<div id="main-div">
	...
	<p>Notes:</p>
	<ul>
	<li>Please login to your {{$mail['keyword']}} portal to take necessary steps immediately &lt;&lt;Company&rsquo;s URL&gt;&gt;</li>
	<li>If you have any questions, contact your {{$mail['keyword']}} administrator @ &lt;&lt;Admin User&rsquo;s Id&gt;&gt;</li>
	</ul>
