...
<div id="Modallevel4" class="modal fade" role="dialog" data-backdrop="static">
  <div class="modal-dialog" id="Modallevel4ContentId" style="width:90%">
...
<div id="Modallevel5" class="modal fade" role="dialog" data-backdrop="static">
  <div class="modal-dialog modal-lg" id="Modallevel5ContentId">
